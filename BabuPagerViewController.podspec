...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of BabuPagerViewController in Markdown format.
  ...
  s.homepage     = "http://EXAMPLE/BabuPagerViewController"
  ...
  # Or just: s.author    = "BABUKUMA"
  # s.authors            = { "BABUKUMA" => "babukuma@gmail.com" }
  ...
  s.source       = { :git => "http://EXAMPLE/BabuPagerViewController.git", :tag => "0.0.1" }
